...
values('piano0224', '12345', null, 19, now());

INSERT INTO member_notnull(id, pwd, in_date)
values('test2','qwer!', now());
...
INSERT INTO member_check values('w');
INSERT INTO MEMBER)CHECK values('asdasd');
SELECT * FROM member_check;

CREATE TABLE member_default(
	id varchar(50),
	in_date datetime DEFAULT curruent_timestamp
...
INSERT INTO board_foreign(title, writer_id) VALUES ('게시글 제목!', null);
