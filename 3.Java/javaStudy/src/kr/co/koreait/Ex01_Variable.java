...
// 			- 개발자가 직접 형변환 해주지 않아도 컴파일 과정에서 자동으로 변호나됨
		...
		//문자를 숫자로 바꾸면 아스키 코드표에 있는 10진수가 나옴
		// - a는 97, A는 65
		char ch = 'a';
		int num5 = ch;
		...
		long lNumber = 10000000000000000L;
		...
		System.out.print("줄바꿈없음, 줄바꿈 할꺼면 개행문자 \n");
		
		System.out.println("줄바꿈을 포함");
		System.out.printf("줄바꿈없음, 변수를 서식문자 사용");
//		서식문자 : 데이터의 출력 형식을 지정하는 특수문자
		...
		int age2 = 19;
		String addr = "인천";
		System.out.printf("안녕하세요. 제 이름은%s입니다. 나이는 %d이고 사는곳은 %s에 살고 있습니다.",name, age, addr); 
		
		
		double pi_double = 3.14;
		System.out.printf("pi_double의 값은 %.2f 입니다. %n", pi_double);
...
//		3. nextDouble();
//		4. next();
		//		-> 단어를 처리할 때 사용되며 공백전까지 입력받은 데이터를 반환
//		5. nextLine();
		// -> 문자열을 처리할 때 사용되며 \n를 기준으로 데이터를 반환
		//	(엔터를 입력하면 \n가 들어감)
//		System.out.print("이름 : ");
